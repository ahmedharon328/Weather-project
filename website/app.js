...
const apiKey="&appid=c32383c3be16829a9d38053bbe1c5387";
...
const updateUI = async()=>{
    ...
    try {
        ...
        const htmlContent = 
        `<div id = "date">Date:${alldata.date}</div>
        <div id = "temp">Temp:${alldata.temp}</div>
        <div id = "content">Feeling:${alldata.content}</div>`
